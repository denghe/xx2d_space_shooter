...
void Sobj_PlaneBullet1::Init(Scene_Game* scene_, xx::XY const& pos_, float const& radians, int64_t const& damage_) {
	scene = scene_;
	pos = pos_;
	damage = damage_;
