...
xx::Task<> Stage5::CoEnter() {
	
	scene->tasks.AddTask(scene->CoShowStageTitle("stage 5"));				// show stage title
...
xx::Task<> Stage5::CoCreateMonsters(int n1, int n2) {
	// i: num frames
	for (int i = 0; i < n1; i++) {
...
xx::Task<> Stage5::CoCreateMonsterTeam(int n, int64_t bonus) {
	// team death counter
