...
xx::Coro Stage3::CoEnter() {
	
	scene->coros.Add(scene->CoShowStageTitle("stage 3"));				// show stage title
...
xx::Coro Stage3::CoCreateMonsters(int n1, int n2) {
	// i: num frames
	for (int i = 0; i < n1; i++) {
...
xx::Coro Stage3::CoCreateMonsterTeam(int n, int64_t bonus) {
	// team death counter
