...
xx::Coro Stage4::CoEnter() {
	
	scene->coros.Add(scene->CoShowStageTitle("stage 4"));				// show stage title
...
xx::Coro Stage4::CoCreateMonsters(int n1, int n2) {
	// i: num frames
	for (int i = 0; i < n1; i++) {
...
xx::Coro Stage4::CoCreateMonsterTeam(int n, int64_t bonus) {
	// team death counter
